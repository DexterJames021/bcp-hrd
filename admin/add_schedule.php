...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO training_courses (course_title, description, start_date, end_date, schedule_time, instructor, designation, location)
            VALUES ('$course_title', '$description', '$start_date', '$end_date', '$schedule_time', '$instructor', '$designation', '$location')";

    if ($conn->query($sql) === TRUE) {
        header("Location: schedule_calendar.php");
        exit();
    } else {
                ...
                <div class="container-fluid dashboard-content ">
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <head>
    <title>Add Training Schedule</title>
    <style>
        body {
