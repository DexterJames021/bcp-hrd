...
$query = "
    SELECT 
        ...
        em.title, 
        em.file_path, 
        u.first_name AS uploaded_by, 
        em.uploaded_at
    FROM 
        employees_manual em
    LEFT JOIN 
        users u ON em.uploaded_by = u.id
    ORDER BY 
        em.uploaded_at DESC
";
...
echo '<div class="container mt-5 pt-5">
    <div class="card shadow-lg rounded">
        <div class="card-header" style="background-color: #0073e6; color: white;">
            <h4 class="mb-0 text-center" style="color: white;">Employee\'s Manual</h4>
        </div>
        <div class="card-body">
...
while ($row = $result->fetch_assoc()) {
    ...
    echo "<td class='text-center'><a class='btn btn-success btn-sm' href='" . $row['file_path'] . "' download><i class='fas fa-download'></i> Download</a></td>";
    echo "<td class='text-center'>" . htmlspecialchars($row['uploaded_by']) . "</td>";
    echo "<td class='text-center'>" . $row['uploaded_at'] . "</td>";
    echo "</tr>";
}
        ...
        <div class="nav-left-sidebar sidebar-dark ">
            <div class="menu-list">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="d-xl-none d-lg-none" href="#">Request Form</a>
                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-3" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                    <li class="nav-item">
                                            <a class="nav-link" href="emloyeesmanual.php">Employee's Manual</a>
                                        </li>
                                        <li class="nav-item">
