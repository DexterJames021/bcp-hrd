                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="index.php">Attendance <span class="badge badge-secondary">New</span></a>
                                        </li>
                                        <li class="nav-item">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="metric-value d-inline-block">
                                    <table style="width: 1550px; border-collapse: collapse;">
                                        <thead>
                                            <tr>
                                                <th style="width: 25%; background-color: #3d405c; color: white; padding: 10px; text-align: left;">ID</th>
                                                <th style="width: 25%; background-color: #3d405c; color: white; padding: 10px; text-align: left;">Name</th>
                                                <th style="width: 25%; background-color: #3d405c; color: white; padding: 10px; text-align: left;">Department</th>
                                                <th style="width: 25%; background-color: #3d405c; color: white; padding: 10px; text-align: left;">Actions</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="padding: 10px;">
                                                    <button style="background-color: #3d405c; color: white; border: none; padding: 5px 10px; cursor: pointer;">Generate</button>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 10px;">2</td>
                                                <td style="padding: 10px;">Bob Smith</td>
