...
<body>
            ...
            <div class="container-fluid dashboard-content ">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="text-muted">Payroll</h5>
                                <div class="metric-value d-inline-block">
                                  
                                    <button onclick="openPaySummaryModal()"
                                        style="background-color: #3d405c; color: white; padding: 10px 20px; border: none; cursor: pointer;">Set
                                        Pay Summary</button>

                                    <!-- Modal -->
                                    <div id="paySummaryModal"
                                        ...
                                        <div
                                            ...
                                            <h3>Set Pay Summary</h3>
                                            <form method="POST" action="pay_summary.php">
                                                <!-- Checkbox Section -->
                                                <label>
                                                    <input type="checkbox" name="role[]" value="admin" required>
                                                    Admin
                                                </label><br><br>
                                                <label>
                                                    <input type="checkbox" name="role[]" value="faculty" required>
                                                    Faculty
                                                </label><br><br>
                                                ...
                                                <button type="submit"
                                                    style="background-color: #3d405c; color: white; padding: 10px 20px; border: none; cursor: pointer;">Save</button>
                                                <button type="button" onclick="closePaySummaryModal()"
    ...
    <thead>
        <tr>
            <th style="background-color: #3d405c; color: white; padding: 10px;">ID</th>
            <th style="background-color: #3d405c; color: white; padding: 10px;">Name</th>
            <th style="background-color: #3d405c; color: white; padding: 10px;">Department</th>
            <th style="background-color: #3d405c; color: white; padding: 10px;">Actions</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            ...
            <td>Alice Johnson</td>
            <td>Marketing</td>
            <td><button onclick="openGenerateModal('Alice Johnson')">Generate</button></td>
        </tr>
        <tr>
            <td>2</td>
            <td>Bob Smith</td>
            <td>Sales</td>
            <td><button onclick="openGenerateModal('Bob Smith')">Generate</button></td>
        </tr>
        <tr>
            <td>3</td>
            <td>Charlie Brown</td>
            <td>Engineering</td>
            <td><button onclick="openGenerateModal('Charlie Brown')">Generate</button></td>
        </tr>
    </tbody>
</table>
...
<div id="generateModal">
    <div>
        ...
        <p id="employeeName">Employee: Alice Johnson</p>
        ...
        <div style="margin-bottom: 20px;">
            <label for="year" style="display: block; margin-bottom: 5px;">Select Year:</label>
        ...
        <div style="text-align: center;">
            <button class="generate-btn" onclick="submitGenerateForm()">Generate</button>
