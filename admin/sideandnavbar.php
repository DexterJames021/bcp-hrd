                                ...
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false"
                                            ...
                                            Resources</a>
                                        <div id="submenu-3-1" class="collapse submenu <?php echo (basename($_SERVER['PHP_SELF']) == 'resource_list.php' ||
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'usercontrol.php') ? 'active' : ''; ?>"
                                            href="<?php echo $base_url; ?>/admin/tech/usercontrol.php">Roles and
                                            Permission
                                            Mangement</a>
                                    </li>
                                    <li class="nav-item">
