...
// Fetch task details
$taskResult = $conn->query("SELECT * FROM tasks WHERE id = $task_id");
...
// Fetch employees for dropdown (assuming 'Employee' usertype)
$employeeResult = $conn->query("SELECT id, CONCAT(first_name, ' ', last_name) AS full_name FROM users WHERE usertype = 'employee'");
...
<body>
    ...
    <style>
        ...
        .card-container { width: 90%; max-width: 800px; margin: 40px auto; background: #fff; border-radius: 16px; padding: 30px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); }
        ...
        button {
            margin-top: 24px; background-color: #6366f1; color: white; padding: 12px 18px;
            border: none; border-radius: 10px; font-size: 16px; cursor: pointer;
        }
        button:hover { background-color: #4f46e5; }
        .back-btn { margin-top: 20px; display: inline-block; background-color: #334155; color: white; padding: 10px 16px; border-radius: 10px; text-decoration: none; }
...
<div class="card-container">
    ...
    <form method="POST">
        ...
        <div class="form-actions">
            <a href="view_tasks.php" class="back-btn">← Back</a>
