...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO training_courses 
        (course_title, description, start_date, end_date, schedule_time, instructor, designation, location)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
    
    $stmt->bind_param("ssssssss", $course_title, $description, $start_date, $end_date, $schedule_time, $instructor, $designation, $location);
                          ...
                          <li class="nav-item ">
                                ...
                                <div id="submenu-5" class="collapse submenu">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="view_contract.php">Contract</a>
                                        </li>
...
<head>
    ...
    <style>
        ...
        .card-container { max-width: 1500px; margin: 40px auto; background: #fff; border-radius: 16px; padding: 30px; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.05); }
        ...
        .action-btn { background-color: #22c55e; color: white; border: none; padding: 10px 14px; border-radius: 10px; font-size: 16px; cursor: pointer; }
    </style>
</head>
<body>
<div class="card-container">
    ...
    <!-- Back button -->
    <a href="courses.php" class="action-btn" style="background-color: #6366f1; margin-bottom: 20px; display: inline-block;">← Back to Courses</a>

    <form method="POST">
        <input type="text" name="course_title" placeholder="Training Title" required>
