...
<body>
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div id="submenu-3-1" class="collapse submenu show">
                                                <ul class="nav flex-column">
                                                    ...
                                                    <li class="nav-item ">
                                                        <a class="nav-link active" href="./retention.php">Retention</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <!-- <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <h2 class="card-title text-align-center">Retention Analytics</h2>
                                <p>sd</p>
                            </div>
                        </div> -->
                        <div class="card p-2">
                            <h2 class="card-title text-align-center">Turnover Rate</h2>
                            <p>if the system
                                detects that a particular department is experiencing higher turnover rates</p>

                            <form id="filterForm" method="GET">
                                <label for="start_date">Start Date:</label>
                                <input type="date" id="start_date" class="block form-control " name="start_date" required>

                                <label for="end_date">End Date:</label>
                                <input type="date" id="end_date" class="block form-control " name="end_date" required>
                        ...
                        <div class="card  p-2">
                            <h2 class="card-title text-align-center">Attendance Over time</h2>
                            <p>Montly Based Attendance</p>
    ...
    <script>
        $.ajax({
            url: "../includes/class/get-retention.php",
            method: "GET",
            success: function(data) {
                const jsonData = JSON.parse(data);

                // Line Chart: Attendance Over Time
                const lineLabels = jsonData.line_chart.map(item => item.date);
                const lineData = jsonData.line_chart.map(item => item.total_attendance);
        ...
        $("#filterForm").on("submit", function(e) {
            ...
            // AJAX request to fetch turnover data
            $.ajax({
                url: "../includes/class/get-retention.php",
                type: "GET",
                data: {
                ...
                success: function(data) {
                    ...
                    const labels = Object.values(data).map(d => d.DepartmentName);
                    const turnoverRates = Object.values(data).map(d => d.TurnoverRate);

                    renderTurnoverChart(labels, turnoverRates);
                },
                error: function(xhr, status, error) {
        ...
        // Function to render the turnover chart
        function renderTurnoverChart(labels, data) {
            const ctx = $("#chartContainer #turnoverChart")[0].getContext("2d");

            // Destroy the previous chart if it exists
            if (window.turnoverChart) window.turnoverChart.destroy();
