...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['id'])) {
    $id = $_GET['id'];
    $result = $conn->query("SELECT * FROM training_courses WHERE id = $id");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['id'])) {
    ...
    $conn->query("UPDATE training_courses SET 
...
<body>
    ...
    <form method="POST" action="edit_schedule.php">
        ...
        <input type="text" name="course_title" value="<?= htmlspecialchars($schedule['course_title']) ?>" required /><br>

        <label for="start_date">Start Date:</label>
        <input type="date" name="start_date" value="<?= htmlspecialchars($schedule['start_date']) ?>" required /><br>

        <label for="schedule_time">Time:</label>
        <input type="time" name="schedule_time" value="<?= htmlspecialchars($schedule['schedule_time']) ?>" required /><br>

        <label for="instructor">Instructor:</label>
        <input type="text" name="instructor" value="<?= htmlspecialchars($schedule['instructor']) ?>" required /><br>

        <label for="designation">Designation:</label>
        <input type="text" name="designation" value="<?= htmlspecialchars($schedule['designation']) ?>" required /><br>

        <label for="location">Location:</label>
        <input type="text" name="location" value="<?= htmlspecialchars($schedule['location']) ?>" required /><br>
