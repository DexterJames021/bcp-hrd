...
<div class="dashboard-header ">
    <nav class="navbar navbar-expand-lg bg-white fixed-top">
        <a class="navbar-brand" href="<?php echo $base_url; ?>/index.php">
            <img src="<?php echo $base_url; ?>/assets/images/bcp-hrd-logo.jpg" alt=""
                ...
                <ul class="navbar-nav flex-column">
                    ...
                    <li class="nav-item">
                        ...
                        <div id="submenu-1" class="collapse submenu bg-light">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo $base_url; ?>/portal/records-management/Records.php">Lorem, ipsum dolor.</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false"
                                        data-target="#submenu-1-1" aria-controls="submenu-1-1">Lorem, ipsum dolor.</a>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="submenu-2" class="collapse submenu bg-light">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo $base_url; ?>/portal/tech/facilities/book_facility.php">Book
                                        Facility</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo $base_url; ?>/portal/tech/facilities/request_resources.php">Request
                                        Resources</a>
                                </li>
                            </ul>
                        </div>
