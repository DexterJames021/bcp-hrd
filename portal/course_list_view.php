...
<body>
    ...
    <style>
        ...
        .card-container { width: 90%;max-width: 1500px; margin: 40px auto; background: #fff; border-radius: 16px; padding: 30px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); }
        h2 { font-size: 24px; font-weight: 600; margin-bottom: 20px; color: #1e293b; }
        table { width: 100%; border-collapse: collapse; margin-bottom: 20px; }
        th, td { padding: 12px 16px; border-bottom: 1px solid #e2e8f0; text-align: center   ; }
        ...
        th:nth-child(1) { width: 15%; } /* Title */
        th:nth-child(2) { width: 15%; } /* Start Date */
        th:nth-child(3) { width: 15%; } /* End Date */
        th:nth-child(4) { width: 15%; } /* Time */
        th:nth-child(5) { width: 10%; } /* Instructor */
        th:nth-child(6) { width: 10%; } /* Designation */
        th:nth-child(7) { width: 25%; }  /* Minimized Location */
