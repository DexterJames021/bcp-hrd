...
include 'config.php';
session_start();
// Fetch all courses — optionally you can filter only completed courses by adding a WHERE status = 'completed'
                ...
                <div class="container-fluid dashboard-content ">
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <head>
    <title>Training Courses for Evaluation</title>
    <style>
        body { background-color: #f1f5f9; font-family: 'Segoe UI', sans-serif; }
        .card-container {
    width: 90%; /* Make the container 90% of the available screen width */
...
<div class="card-container">
    <h2>Training Courses for Evaluation</h2>
    ...
    <table>
        ...
        <tr>
        <td style="font-size: large;"><?= htmlspecialchars($course['course_title']) ?></td>
        <td style="font-size: large;"><?= htmlspecialchars($course['instructor']) ?></td>
            <td><a href="trainer_evaluation_form.php?course_id=<?= $course['id'] ?>" class="action-btn">➡️Evaluate</a>
            </td>
        </tr>
        <?php endwhile; ?>
    </table>
    <?php else: ?>
        <p>No training courses available for evaluation.</p>
    <?php endif; ?>
