                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <!-- <li class="nav-item ">
                                <a class="nav-link active" href="leave.php" >
                                    <i class="fas fa-fw fa-home"></i> My Leave
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link active" href="requests.php" >
                                    <i class="fas fa-fw fa-home"></i> Leave Requests
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link active" href="holiday.php" >
                                    <i class="fas fa-fw fa-home"></i> Holidays
                                </a>
                            </li> -->
                            <li class="nav-item ">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-9" aria-controls="submenu-9"><i class="fas fa-fw fa-money-check-alt"></i>Compensation and Benefits</a>
