...
require '../../admin/tech/includes/class/Employee.php';
...
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <!-- left sidebar -->
        <!-- ============================================================== -->
        <div class="nav-left-sidebar sidebar-dark rounded mt-4 ml-3 h-10">
            <div class="menu-list">
                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-3" class="collapse submenu show">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link " href="./index.php">Assest and facility</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="./room_book_list.php">Room booking request</a>
                                        </li>
                                        <li class="nav-item">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <h2 class="card-title">Asset and Inventory Management</h2>
                                <button type="button" class="btn btn-primary float-right"
                                    data-toggle="modal" data-target="#addAsset">Add Assets</button>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="modal-body">
                                    <form id="assets_form">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" required name="quantity" id="quantity" placeholder="Quantity">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control" required name="last_maintenance" id="last_maintenance">
                                        </div>
                                        <div class="mb-3">
                                            <label for="next_maintenance" class="form-label">Next Maintenance:</label>
                                            <input type="date" class="form-control" required name="next_maintenance" id="next_maintenance">
                                        </div>
...
<script>
    $(function() {
        ...
        function load_fm() {
            $.get('../../admin/tech/includes/encode/assets_api.php?action=fetch', function(data) {
                facility.clear();
        ...
        asset_form.on('submit', function(e) {
            ...
            $.post('../../admin/tech/includes/encode/assets_api.php?action=create',
                $(this).serialize(),
                function(response) {
        ...
        facility.on('click', '.delete', function() {
            ...
            $.post('../../admin/tech/includes/encode/assets_api.php?action=delete', {
                id
            }, function(response) {
                if (response.success) {
                    load_fm()
