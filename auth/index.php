...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($err == "") {
        // Use a prepared statement and proper comparison
        ...
        if ($user && $user->password === $password) { // NOTE: Use password_hash() in production!
            ...
            if ($user->usertype === 'admin') {
                ...
                // Make sure `employeeID` exists in your users table or join it from employees table
                $_SESSION['employeeID'] = $user->employeeID ?? $user->id; // adjust depending on schema
                $_SESSION['employeeType'] = $user->employeeType ?? 'Teaching'; // if you store it
